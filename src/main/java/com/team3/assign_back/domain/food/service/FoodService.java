...
public class FoodService {
    ...
    public void createFoods(FoodAnalysisRequestDto foodAnalysisRequestDto){
        ...
        foodNames.removeAll(foodRepository.findNamesNotIn(foodNames));
    ...
    public void createTasteMetricsEmbedding(){
        ...
        filterTwoLists(tasteMetricsWithoutEmbedding, embeddingVectorList);

        List<String> embeddingVectorToStringList = embeddingVectorList.stream().map(vector -> Arrays.toString(vector)
                .replace(" ", "")).toList();

        batchCreateTasteMetricsEmbedding(embeddingVectorToStringList, tasteMetricsWithoutEmbedding);
    ...
    @Async
    @Transactional
    private void batchCreateTasteMetricsEmbedding(List<String> embeddingVectorToStringList, List<TasteMetrics> tasteMetricsWithoutEmbedding) {

        String sql = "INSERT INTO taste_metrics_embedding (taste_metrics_id, text_embedding, created_at, updated_at) VALUES (?, ?::vector, ?, ?)";
